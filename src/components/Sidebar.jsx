  ...
  return (
    ...
    >
      <div>
        ...
        {/* Navigation Items */}
        <nav className="p-3 space-y-2 overflow-y-auto max-h-[calc(100vh-140px)]">
          ...
          <div className="relative group w-full">
            <button
              ...
              } rounded-lg text-xs font-semibold transition-all duration-200 ease-in-out cursor-pointer ${
                isActive('/dashboard') 
